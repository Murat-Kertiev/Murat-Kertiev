...
### <div align="center">Привет! Я Мурат, Python-разработчик.</div>  
  

- 🔭 Изучаю новые технологии  
  

- 📚 Завершил курсы по Python-Разработке Яндекс Практикум!  
  

- ⚡ Являюсь старшим студентом на курсах Python-Разработчик Яндекс Практикум  
